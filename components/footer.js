  ...
  footerEl.innerHTML = `
        ...
        <nav class="footer__links-nav">
          ...
          <div class="footer__link-div">
            ...
            <a class="footer__link poppins-regular" href="./index.html#servicios">Servicios</a>
          </div>
          <div class="footer__link-div">
            <img class="footer__link-icon" src="./img/phone.svg" />
            <a class="footer__link poppins-regular" href="./index.html#contacto">Contacto</a>
          </div>
        </nav>
        <nav class="footer__social-nav">
          ...
          <a class="footer__social-link" href="https://github.com/nicososaok/" target="_blank">
            <img src="./img/github.png" />
          </a>
          <a class="footer__social-link" href="https://x.com/nicososadev" target="_blank">
            <img src="./img/twitter.png" />
          </a>
        </nav>
        <a class="footer__apx-link poppins-regular" href="https://apx.school" target="_blank">
          ©2026 - https://apx.school
        </a>
  `;
